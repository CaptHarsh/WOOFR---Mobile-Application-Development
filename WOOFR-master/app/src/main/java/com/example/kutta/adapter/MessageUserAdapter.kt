...
import com.example.kutta.databinding.UserItemLayoutBinding
...
class MessageUserAdapter( val context: Context, private val list: ArrayList<String>, private val chatKey : List<String> ) :RecyclerView.Adapter<MessageUserAdapter.MessageUserViewHolder>(){
